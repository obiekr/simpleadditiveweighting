  ...
  return (
    ...
    <div className="drawer w-full">
      <div className="navbar bg-base-100 gap-x-10">
        ...
        <div className="flex">
          <a className="btn btn-ghost text-xl h-fit">SAW Employee Calculator</a>
        </div>
        ...
        <ul className="menu p-4 w-64 min-h-full bg-base-200 text-base-content  h-full flex flex-col justify-between">
          ...
          <div className="">
            <label htmlFor="my-drawer" aria-label="close sidebar" className="drawer-overlay">
              <a className="btn btn-ghost text-xl h-fit" htmlFor="my-drawer" aria-label="close sidebar">SAW Employee Calculator</a></label>
            <div className="mt-16">
